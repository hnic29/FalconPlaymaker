  ...
  if (!ball) {
    return (
      <div className="bg-navy-900 border border-navy-700 rounded-lg p-3">
        ...
        <button
          onClick={onAdd}
          className="w-full px-2 py-1.5 rounded bg-gold-500 text-navy-950 text-xs font-bold hover:bg-gold-400"
        >
  ...
  return (
    <div className="bg-navy-900 border border-navy-700 rounded-lg p-3">
      ...
      <div className="flex gap-2">
        ...
        <button onClick={onDelete} className="px-2 py-1 rounded text-xs font-semibold text-slate-400 hover:text-red-400 ml-auto">
          🗑 Remove
        </button>
      </div>
    </div>
